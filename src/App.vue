 ...
 * @author R.Wood
 * @requires vuex
 * @requires module:MainNav - @constant {Object} MainNav - main nav bar for the app
 */
...
export default {
	...
	/**
	 * @namespace data
	 * @property {Object[]} classTemplates - array of class template objects
	 */
	components: { MainNav },
	computed : {
		...mapGetters(["getClassTemplates"]),
		fakeData () {
			return this.$store.getters.getClassTemplates;
		}
	}
};
</script>
